...
const num_of_tiles = 13;
// import * as data from './tiles/circuit/tiles.json' assert {type:'json'};
// const {tiles_json} = data;
...
function setup() {
  ...
  if(path == 'tiles/circuit-coding-train' || path == 'tiles/circuit/'){
    ...
    // tiles[13] = new Tile(tileImages[13], ['AAA', 'AAA', 'AAA', 'AAA']);
  }else if(path == 'tiles/demo'){
    tiles[0] = new Tile(tileImages[0], ['AAA', 'AAA', 'AAA', 'AAA']);
